...
select
  ...
  countif(subscription_period_start <= date '2023-07-31'
          and subscription_period_end >= date '2023-07-01')                as approx_mau_flag
...
select tenure, cohort_size, never_churned_retention, total_retention
from {{ ref('viz_cohort_retention') }}
